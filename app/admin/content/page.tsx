...
export default async function ContentManagement() {
  ...
  if (!adminRole || !["super_admin", "content_admin"].includes(adminRole.role)) {
    redirect("/dashboard")
  }
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Create and manage articles and guidelines</p>
            </div>
            <Button>
      ...
      <div className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            <CardTitle>All Content ({content?.length || 0})</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
